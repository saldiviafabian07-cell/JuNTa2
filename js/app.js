...
(() => {
  ...
  $('yoNuncaNuncaGameBtn').onclick=openYoNuncaNuncaOffline;
  $('offlineYoNuncaNuncaBtn').onclick=event=>{event.preventDefault();event.stopPropagation();openYoNuncaNuncaOffline();};
  ...
  $('yoNuncaNuncaNextBtn').onclick=nextYoNuncaNuncaPhrase;$('yoNuncaNuncaRestartBtn').onclick=restartYoNuncaNunca;$('yoNuncaNuncaBackBtn').onclick=exitYoNuncaNunca;
