...
(() => {
  ...
  function startYoNuncaNuncaGame(){
    state.yoNuncaNunca={deck:shuffleArray(yoNuncaNuncaData),index:-1};
    state.mode='local';state.gameType=null;state.roomRef=null;state.roomCode='';state.lastRoomData=null;
    show('yoNuncaNunca');nextYoNuncaNuncaPhrase();
  }
  ...
  function restartYoNuncaNunca(){startYoNuncaNuncaGame();}
  ...
  $('yoNuncaNuncaGameBtn').onclick=startYoNuncaNuncaGame;
  $('offlineYoNuncaNuncaBtn').onclick=startYoNuncaNuncaGame;
  ...
  $('yoNuncaNuncaNextBtn').onclick=nextYoNuncaNuncaPhrase;$('yoNuncaNuncaRestartBtn').onclick=restartYoNuncaNunca;
