...
export function createNavigation({
  ...
  function show(id, {history = true, replace = false} = {}) {
    ...
    const labels = {
      ...
      whoamiLocalFinalReveal:'¿QUIÉN SOY?',ageLocalFinalReveal:'ADIVINA LA EDAD',yoNuncaNunca:'YO NUNCA NUNCA'
    };
    ...
    const pageTitles = {
      ...
      yoNuncaNunca:'YO NUNCA NUNCA · JuNTa2',
    ...
    $('connectionStatus')?.classList.toggle('hidden', authOnly.includes(id) || id === 'yoNuncaNunca');
